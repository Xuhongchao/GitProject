define(['angular'], function () {
    return angular.module('dmpwebApp.controllers.grabWaitAppMobileCtrl', [])
        .controller('grabWaitAppMobileCtrl', ['$scope','$location','$http','$uibModal','uiGridConstants','gridService','$upload','$timeout','$compile','$templateCache', function ($scope,$location,$http,$uibModal,uiGridConstants,gridService,$upload,$timeout,$compile,$templateCache) {
